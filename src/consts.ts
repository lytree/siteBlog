...
import authorAvatarImage from "./public/akkarin.jpg";
import headerImageDay from "./public/header_day.jpg";
import headerImageNight from "./public/header_night.webp";
...
export const SITE_MENU: { title: string, href: string, target: string }[] = [
    { title: "首页", href: "./docs", target: "" },
    { title: "归档", href: "./docs/archive/", target: "" },
    { title: "关于", href: "./docs/about/", target: "" },
    { title: "链接", href: "./docs/links/", target: "" },
    { title: "外部链接", href: "https://www.github.com", target: "_blank" }
]
